...
namespace Courses.Gui.Client
{
    public class Startup2
    {
        ...
        private DAL.AccountRepository AccountRepositoryCreate()
        {
            return new DAL.AccountRepository();
        }
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext<DAL.AccountRepository>(AccountRepositoryCreate);
